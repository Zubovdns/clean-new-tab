        ...
        >
          ...
          <div className="flex items-center justify-between pb-4 border-b border-inherit mb-5">
            <div className="flex items-center gap-2.5">
              <div
                className={`p-1.5 rounded-lg ${isDark ? 'bg-[#35363a] text-[#8ab4f8]' : 'bg-[#e8f0fe] text-[#1a73e8]'}`}
              >
            ...
            {isConnected ? (
              ...
              >
                <p className="text-xs text-[#9aa0a6] leading-relaxed">
                  Синхронизируйте секции и закладки между браузерами и компьютерами в защищенный
                  Secret Gist на вашем GitHub аккаунте.
                </p>
                ...
                {activeTab === 'device' ? (
                  ...
                  <SyncPatTab isDark={isDark} onConnectWithPAT={onConnectWithPAT} />
                )}
          ...
          <BackupSection isDark={isDark} sections={sections} onImportSections={onImportSections} />
        </div>
      </div>
    );
  },
