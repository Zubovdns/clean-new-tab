  ...
  ({
    ...
    return (
      ...
      >
        ...
        >
          <h2 className="text-[16px] font-medium mb-4 select-none">Добавить ярлык</h2>

          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            {/* Select section if multiple sections exist */}
            {sections.length > 1 && (
              <div>
                <label className="block text-xs font-normal text-[#9aa0a6] mb-1">Секция</label>
                <select
            ...
            <div>
              <label className="block text-xs font-normal text-[#9aa0a6] mb-1">Название</label>
              <input
                type="text"
                value={title}
            ...
            <div>
              <label className="block text-xs font-normal text-[#9aa0a6] mb-1">URL</label>
              <input
                type="text"
                value={url}
